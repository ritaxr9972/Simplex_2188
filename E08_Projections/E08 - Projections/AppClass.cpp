...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		//m_pCamera->SetPosition(vector3(20, 0, 0));
		m_pCamera->SetPerspective(false);
		m_pCamera->SetPositionTargetAndUpward(vector3(10.0f,0.0f,1.0f),vector3(0.0f,0.0f,0.0f),vector3(0.0f,0.0f,-10.0f));
		m_pCamera->SetHorizontalPlanes(vector2(-10.0f,10.0f));
		m_pCamera->SetVerticalPlanes(vector2(-11.0f,11.0f));
		break;
	case 4:
		m_pCamera->ResetCamera();
	...
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(vector3(0, 0, -15));
		m_pCamera->SetNearFar(vector2(5.0f,-10.0f));
		break;
	case 6:
		m_pCamera->ResetCamera();
		//m_pCamera->SetPosition(vector3(0, 0, -30));
		//m_pCamera->SetPerspective(false);
		m_pCamera->SetPosition(vector3(0.0f,0.0f,-15.0f));
		m_pCamera->SetNearFar(vector2(10.0f,2.0f));
		break;
	case 7:
		m_pCamera->ResetCamera();
		m_pCamera->SetPerspective(false);
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, -0.001f, 10.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 0.0f, -10.0f));
		break;
	}
